...
public:
	...
	void send_my_info(const LittleWolf::Point &pos,	int health, int score, Uint8 state);
	void send_player_info(uint8_t id, const LittleWolf::Point &pos, int health, int score, uint8_t state);
